					...
					one: {
						...
						callback: () =>
							ChatMessage.create({
								...
								content: game.specialDiceRoller.genesys.rollFormula(
									genesysUtil.diceArrayToString(genesysUtil.abilityToArray(charPres, skillCool))
								),
							}),
					},
					two: {
						...
						callback: () =>
							ChatMessage.create({
								...
								content: game.specialDiceRoller.genesys.rollFormula(
									genesysUtil.diceArrayToString(genesysUtil.abilityToArray(charWill, skillVig))
								),
							}),
					},
				},
